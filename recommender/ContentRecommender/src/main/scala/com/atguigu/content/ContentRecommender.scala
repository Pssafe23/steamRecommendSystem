...
// 需要的数据源是电影内容信息
case class Movie(mid: Int,name:String,descri:String,timelong:String,Developers:String,genres:String)
...
object ContentRecommender {
  ...
  // 定义表名和常量
  val MONGODB_MOVIE_COLLECTION = "Game"

  val CONTENT_MOVIE_RECS = "ContentGameRecs"
